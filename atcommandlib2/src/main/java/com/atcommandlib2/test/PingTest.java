package com.atcommandlib2.test;
    ...
    public void run() {
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                Log.d("DataPing====", String.valueOf(instantRtt));
                }
                if (line.startsWith("rtt")) {
                    avgRtt = Double.parseDouble(line.split("/")[4]);
                    jitter =Double.parseDouble(line.split("/")[6].split(" ")[0]);
                    Log.d("DataPing2======", String.valueOf(avgRtt));

                    Log.d("DataPing2jitter======", String.valueOf(jitter));
                    Log.d("DataPing2======", line);
